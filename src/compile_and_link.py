...
def compile_and_link(cpp_version: int, shared: bool, static: bool, \
    ...
    o_changed = compile(cpp_version, src_dir_path, include_dir_paths, build_dir_path)

    link(cpp_version, shared, static, lib_names, lib_dir_paths, build_dir_path, target_path, o_changed)